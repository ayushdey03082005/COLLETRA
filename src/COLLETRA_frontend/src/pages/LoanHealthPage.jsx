...
export default function LoanHealthPage({ theme, loanData }) {
  ...
  return (
    <div className="p-4 sm:p-8 space-y-8">
      ...
      <GlassCard>
        ...
        <p className="text-gray-600 dark:text-gray-400">Your next repayment is due on <span className="text-cyan-500 dark:text-cyan-400">{loanData ? new Date(loanData.repaymentDueDate).toLocaleDateString() : '...'}</span>. Consider adding more collateral or making an early payment to improve your loan health.</p>
