                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        ...
                        <input 
                            ...
                            className="w-full bg-gray-200/50 dark:bg-gray-800/50 border border-gray-300 dark:border-purple-500/30 rounded-lg px-4 py-2 text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-cyan-400" 
                        />
                    </div>
                    <div>
